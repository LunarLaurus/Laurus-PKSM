...
void NetworkStorageScreen::setBoxName(bool storage)
{
    if (storage)
    {
        SwkbdState state;
...
NetworkStorageScreen::NetworkStorageScreen()
             ...
             i18n::localize("B_BACK"))
{
    ...
    mainButtons[8] = std::make_unique<ClickButton>(
        3, 211, 28, 28,
        [this]()
        {
...
void NetworkStorageScreen::drawBottom() const
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
void NetworkStorageScreen::drawTop() const
{
...
void NetworkStorageScreen::update(touchPosition* touch)
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
bool NetworkStorageScreen::prevBox(bool forceBottom)
{
...
bool NetworkStorageScreen::prevBoxTop()
{
    storageBox--;
    if (storageBox == -1)
    {
...
bool NetworkStorageScreen::nextBox(bool forceBottom)
{
    if (storageChosen && !forceBottom)
    {
        storageBox++;
...
bool NetworkStorageScreen::nextBoxTop()
{
    storageBox++;
    if (storageBox == Banks::bank->boxes())
    {
...
bool NetworkStorageScreen::clickBottomIndex(int index)
{
...
bool NetworkStorageScreen::backButton()
{
    if (!backHeld)
    {
        backHeld = true;
...
bool NetworkStorageScreen::showViewer()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
bool NetworkStorageScreen::clearBox()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
bool NetworkStorageScreen::releasePkm()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
bool NetworkStorageScreen::isValidTransfer(const pksm::PKX& moveMon, bool bulkTransfer)
{
...
void NetworkStorageScreen::pickupSwap()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
void NetworkStorageScreen::pickupSingle()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
void NetworkStorageScreen::pickupMulti()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
void NetworkStorageScreen::postPickup()
{
    if (pickupMode == MULTI && currentlySelecting)
    {
        return;
...
bool NetworkStorageScreen::checkPutDownBounds()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
void NetworkStorageScreen::putDownSwap()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
void NetworkStorageScreen::putDownNonSwap()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
void NetworkStorageScreen::pickup()
{
    if (moveMon.empty())
    {
        switch (pickupMode)
...
void NetworkStorageScreen::doDump(const pksm::PKX& dumpMon)
{
...
bool NetworkStorageScreen::dumpPkm()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
bool NetworkStorageScreen::duplicate()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
bool NetworkStorageScreen::swapBoxWithStorage()
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
...
void NetworkStorageScreen::scrunchSelection()
{
...
void NetworkStorageScreen::grabSelection(bool remove)
{
    u8 maxPkmInBox = (TitleLoader::save->generation() <= pksm::Generation::TWO &&
                         TitleLoader::save->language() != pksm::Language::JPN)
                       ? 20
